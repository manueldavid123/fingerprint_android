  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `fingerprints` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `accepted` INTEGER NOT NULL, `timestamp` INTEGER)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"4ad175717337b5aeca426ea5c741ee87\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsFingerprints = new HashMap<String, TableInfo.Column>(3);
    ...
    }, "4ad175717337b5aeca426ea5c741ee87", "30dd453f831811edc9724e538c1ae85d");
